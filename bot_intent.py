...
内容发现（结果进入候选池，不直接发布）：
- keyword_sweep                手动触发关键词扫描（所有分类关键词）
                               示例："扫一下关键词"、"搜索最新的 AI 动态"、"全面扫一遍"
                               "关键词跑一遍"、"帮我看看最新的行业动态"
...
关键词查询管理：
- list_keyword_queries         查看当前所有关键词搜索查询
                               示例："看看关键词设置"、"现在监控哪些话题"
- keyword_refresh              触发关键词刷新建议（xAI 分析并推荐 add/retire）
                               示例："关键词有没有需要更新的"、"让 AI 看看关键词要不要调整"
